                ...
                <div class="splide rlr-media--wrapper rlr-js-media">
                    ...
                    <div class="splide__track rlr-media__strack">
                        <ul id="image-preview" class="splide__list">
                            <#list hotel.images?split(";") as image>
                    ...
                    <div class="rlr-media__custom-pagination rlr-js-custom-pagination">
                        ...
                        <span class="rlr-media__page-counter rlr-js-page">
                            ${hotel.images?split(";")?size!"0"} </span>
                    </div>
                </div>
            </div>
            <!-- Media Thumbnails -->
        ...
        <section class="row rlr-product-detail-section">
            <div class="rlr-product-detail-section__details col-xl-8">
                ...
                <div class="rlr-product-detail-header" id="rlr-js-detail-header">
                    <div class="rlr-product-detail-header__contents">
                        ...
                        <h1 class="rlr-section__heading--main rlr-product-detail-header__title">${hotel.name!""}</h1>
                        <div class="rlr-review-stars" itemscope itemtype="https://schema.org/Product">
                            ...
                            <div class="rlr-review-stars__content">
                                <span class="rlr-review-stars__count">0</span>
                                <span> Reviews</span>
                            </div>
                        </div>
                    </div>
                    <div class="rlr-product-detail-header__actions">
                        ...
                        <div class="rlr-product-detail-header__button-wrapper">
                            <button type="button" data-id="${hotel.id}"
                            ...
                            <div class="rlr-overview-detail__icon-group">
                                ...
                                <div class="rlr-overview-detail__icons">
                                    <figure class="rlr-icon-text"><i class="rlr-icon-font flaticon-telephone"> </i>
                                        <span class="">${hotel.phone!""}</span></figure>
                                </div>
                            </div>
                        </div>
                        <div class="rlr-overview-detail__icon-groupset">
                            <#if hotel.service?? && hotel.service?length gt 0>
                                <#list hotel.service?split("|") as service>
                                    <div class="rlr-overview-detail__icon-group">
                                        <span class="rlr-overview-detail__label"></span>
                                        <div class="rlr-overview-detail__icons">
                                            <figure class="rlr-icon-text">
                ...
                <div class="rlr-secondary-menu-desc" data-id="rlr-product-sec-itinerary">
                    ...
                    <div class="rlr-secondary-menu-desc__details">
                        ...
                        <div class="accordion rlr-accordion">
                            <#if hotelTypeList?? && hotelTypeList?size gt 0>
                                <#list hotelTypeList as hotelType>
                                    <div class="accordion-item rlr-accordion__item">
                                        <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header${hotelType_index+1}">
                                            <button class="accordion-button rlr-accordion__button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse${hotelType_index+1}"
                                                    aria-expanded="false" aria-controls="rlr-itinerary-collapse${hotelType_index+1}"><span
                                                        class="rlr-accordion__badge">${hotelType_index+1}</span> ${hotelType.name}
                                            </button>
                                        </div>
                                        <div id="rlr-itinerary-collapse${hotelType_index+1}" class="accordion-collapse collapse"
                                             aria-labelledby="rlr-itinerary-header${hotelType_index+1}" style="">
                                            <div class="accordion-body rlr-accordion__body">
                                                ...
                                                <div class="rlr-overview-detail__icon-groupset">
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                <i class="rlr-icon-font flaticon-deals"> </i>
                                                                <span class="">Today's price:${hotelType.price!"0"}.00 </span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                ...
                                                                <span class="">Number of single beds:${hotelType.number!""} </span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                <i class="rlr-icon-font flaticon-carbon-tall-man"> </i>
                                                                <span class=""> Number of guests:${hotelType.guestNumber!""}</span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                <i class="rlr-icon-font flaticon-hall"> </i>
                                                                <span class=""> proportion:${hotelType.area!"0"}m²</span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                <i class="rlr-icon-font flaticon-gallery"> </i>
                                                                <span class=""> landscape:${hotelType.landscape!""}</span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                <i class="rlr-icon-font flaticon-hotel-bed"> </i>
                                                                <span class="">Number of rooms:${hotelType.roomNumber!"0"} </span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                    <div class="rlr-overview-detail__icon-group">
                                                        ...
                                                        <div class="rlr-overview-detail__icons">
                                                            <figure class="rlr-icon-text">
                                                                <i class="rlr-icon-font flaticon-hotel-bed"> </i>
                                                                <span class="">Number of rooms remaining:${hotelType.defaultNumber!"0"} </span>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="rlr-itinerary__media-group">
                                                    Room features:
                                                    <#if hotelType.introduce?? && hotelType.introduce?length gt 0>

                                                        <#list hotelType.introduce?split("|") as intro>
                                                            <div class="rlr-overview-detail__icon-groupset">
                                                                <div class="rlr-overview-detail__icon-group">
                                                                    <span class="rlr-overview-detail__label"></span>
                                                                    <div class="rlr-overview-detail__icons">
                                                ...
                                                <div class="rlr-itinerary__tabbed-content">
                                                    ...
                                                    <div class="tab-content rlr-tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active" id="rlr-itinerary-accomodation"
                                                             role="tabpanel">
                                                            <div class="rlr-readmore-desc">
                                                                Facilities provided：
                                                                <div class="rlr-overview-detail__icon-groupset">
                                                                <#if hotelType.details?? && hotelType.details?length gt 0>

                                                                    <#list hotelType.details?split("|") as detail>
                                                                            <div class="rlr-overview-detail__icon-group">
                                                                                <span class="rlr-overview-detail__label"></span>
                                                                                <div class="rlr-overview-detail__icons">
                                                                                    <figure class="rlr-icon-text">
                                                            ...
                                                            <div class="rlr-itinerary__room-details">
                                                                ...
                                                                <div class="rlr-itinerary__media-group">
                                                                    <#if hotelType.images?? && hotelType.images?length gt 0>
                                                                        <#list hotelType.images?split(";") as img>
                                                                            <div class="rlr-itinerary__media">
                                                                                <a  data-url="${img}" class="images_gallery"
                                                                                   href="javascript:void(0);">
                                                                                    <figure class="rlr-lightbox--gallery__figure">
                                                                                        <img class="rlr-lightbox--gallery__img"
                                                                                             src="/photo/view?filename=${img}"
                                                                                             alt="Anchor Button">
                                                                                        <figcaption
                                                                                                class="rlr-lightbox--gallery__figcaption">
                                                                                            <span>${img_index+1}</span>
                                                                                        </figcaption>
                                                                                    </figure>
                                                                                </a>
                                                                            </div>
                                ...
                                <#else>
                                    <div><h2>No rooms available yet</h2></div>
                            </#if>
                                                ...
                                                <div class="rlr-review-card__contact">
                                                    ...
                                                    <div class="rlr-avatar">
                                                        ...
                                                        <span class="rlr-avatar__name" itemprop="name">
                                                            <#if reply.account??>
                                                                ${reply.replyAccount.username!""}->回复:${reply.account.username}
                                                            <#else>
            ...
            <#if ylrc_home??>
                <aside class="col-xl-4 col-xxxl-3 d-xl-block offset-xxxl-1 mt-5 mt-lg-0">
                    <form class="rlr-booking-card" id="appoint-room-form">
                        <input type="hidden" name="hotelId" value="${hotel.id}"/>
                        <input type="hidden" name="roomIds" class="required" tips="Please select a room" id="appoint-roomIds"/>
                        <fieldset class="rlr-fieldrow">
                            ...
                            <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                                ...
                                <div class="input-daterange input-group" id="test6">
                                    <input type="text" autocomplete="off" id="test-startDate-1" name="checkInDate" class="layui-input required" tips="Please fill in the check-in date" placeholder="Check-in date">                                <span class="input-group-addon"><i class="mdi mdi-chevron-right"></i></span>
                                    <input type="text" autocomplete="off" id="test-endDate-1" name="checkOutDate" class="layui-input required" tips="Please fill in the check-out date" placeholder="Check-out date">                            </div>
                            </div>
                            <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-travellers-input"> Travellers </label>
                                <div class="rlr-input-group"  >
                                    <input type="number" value="1" name="personalNumber"  class="form-control form-input">
                                </div>
                            </div>
                            <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-selection-input"> Selections </label>
                                <div class="rlr-input-group" data-bs-toggle="popover-booking" data-content-id="rlr-js-booking-selection"
                                     id="rlr-js-booking-selection-button">
                      ...
                      <span class="rlr-svg-icon">
                                ...
                                <div id="rlr-js-booking-selection" class="rlr-popover--hide">
                                    <div id="rlr-js-booking-selection-bookingform" data-name="booking-form">
                                        <div class="rlr-popover__header">
                                            ...
                                            <button type="button" onclick="selectRoomType(this)" class="btn rlr-button rlr-js-booking-close rlr-button--transparent">
                                                    ...
                                                    <li class="form-check form-check-block rlr-popover__checkbox-wrapper">
                                                        <div class="rlr-popover__checkbox">
                                                            <input class="form-check-input rlr-form-check-input"
                                                                   id="rlr-booking-single-room${hotelType.id}" type="checkbox"
                                                                   value="${hotelType.name}"  data-id="${hotelType.id}" />
                                                            <label class="rlr-form-label rlr-form-label--checkbox"
                                                                   for="rlr-booking-single-room${hotelType.id}">${hotelType.name!""} </label>
                                                        </div>
                                                        <span class="rlr-popover__price">$${hotelType.price!"0"}.00</span>
                                                    </li>
                                                </#list>
                        ...
                        <a href="javascript:void(0);"
                           class="btn rlr-button rlr-booking-card__button" id="appoint-room-btn"> Proceed to Booking </a>
                    </form>
                </aside>
            </#if>
...
<script type="text/javascript">
    ...
    $(".add-favorites-btn").click(function () {
        ...
        ajaxRequest('add_hotel_favorites', 'POST', {id: id}, function (result) {
    ...
    $(".reply-comment-btn").click(function () {
        ...
        $("#reply-content-btn").click(function () {
            ...
            var id = $("#reply-id").val();
            ajaxRequest('/home/hotel/reply_comment', 'POST', {
                commentId: id,
                content: content,
                accountId: accountId
            }, function (result) {
   ...
   function selectRoomType(t){
        var ids="";
       $('input[class="form-check-input rlr-form-check-input"]:checked').each(function(i,e){
            var id=$(e).attr("data-id");
           ids+=id+",";
       });
       $("#appoint-roomIds").val(ids.substring(0,ids.length-1));
   }


   //预约客房操作
   $("#appoint-room-btn").click(function () {
        if(!checkForm('appoint-room-form')){
            return;
        }
        var data=$("#appoint-room-form").serialize();
        ajaxRequest('/home/hotel_order/create_order','POST',data,function (result) {
           showSuccessMsg("Order created successfully, go to payment",function () {
               window.location.href="/home/hotel_order/to_pay?oid="+result.data;
           })
        })
   })
