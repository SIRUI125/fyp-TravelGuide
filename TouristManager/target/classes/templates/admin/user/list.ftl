              ...
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="${username!""}" name="username" placeholder="Please enter user name">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                        	<#if user.status == 1>
                        	<font class="text-success">normal</font>
                        	<#else>
                        	<font class="text-warning">frozen</font>
                        	</#if>
                        </td>
                        <td style="vertical-align:middle;">
                        	<#if user.sex == 1>
                        	...
                        	<#else>
                        	<font class="text-warning">unknown</font>
                        	</#if>
                        </td>
                    ...
                    <#else>
                    <tr align="center"><td colspan="9">Nothing here！</td></tr>
					</#if>
                    </tbody>
                  </table>
                </div>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('User deleted successfully!',function(){
