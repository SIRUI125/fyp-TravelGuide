...
<head>
    ...
    <title>${siteName!""}|Blog Management-${title!""}</title>
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as blog>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${blog.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;width: 300px;">
                                                        <#if blog.coverPic?? && blog.coverPic?length gt 0>
                                                                <img src="/photo/view?filename=${blog.coverPic}"
                                                    ...
                                                    <td style="vertical-align:middle;">
                                                        <font class="text-success">${blog.createTime}</font>
                                                    </td>
                                                </tr>
                                            </#list>
                                        <#else>
    ...
    function deleteReq(id, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('Blog deleted successfully!', function () {
