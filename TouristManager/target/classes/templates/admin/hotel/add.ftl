...
<title>${siteName!""}|Hotel Management-Add hotel</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>Add hotel</h4></div>
              <div class="card-body">
                <form id="hotel-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="number" class="form-control required" id="add-avgPrice"
                           name="avgPrice"
                           value=""
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="tel" class="form-control required" id="add-phone"
                           name="phone"
                           value=""
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <textarea style="height:250px" id="add-service"
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <textarea style="height:250px" class="form-control" id="add-remark" name="remark"></textarea>
                  </div>
...
$(document).ready(function(){
  KindEditors("add-content");
	...
	$("#add-form-submit-btn").click(function(){
		if(!checkForm("hotel-add-form")){
			return;
		}
		var data = $("#hotel-add-form").serialize();
		$.ajax({
			url:'add',
			type:'POST',
			data:data,
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('Hotel added successfully!',function(){
