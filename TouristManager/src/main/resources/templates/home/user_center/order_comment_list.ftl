...
<html lang="en">
            ...
            <div class="row">
              ...
              <div class="content col-lg-9 col-xs-12">
                <div class="rlr-data-container woocommerce-MyAccount-content">
                  <h1 class="type-h3 rlr-data-table__title">Your SCENIC  ORDERS COMMENTS</h1>
                  <div class="table">
                      ...
                      <#if pageBean.content?size gt 0>
                        ...
                        <tr class="rlr-data-table__row woocommerce-orders-table__row woocommerce-orders-table__row--status-on-hold order">
                          <td class="rlr-data-table__cell woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number" data-title="Order">
                            <img src="/photo/view?filename=${comment.scenicOrder.scenicPrice.scenic.coverPic}" style="width:200px;height: 200pd;">
                          </td>

                          <td class="rlr-data-table__cell woocommerce-orders-table__cell woocommerce-orders-table__cell-order-number" data-title="Order">
                          <a href="/home/tourist/detail?id=${comment.scenicOrder.scenicPrice.scenic.id}">${comment.scenicOrder.scenicPrice.scenic.title!""}</a>
                          </td>
  ...
  <script type="text/javascript">
    ...
    $(".delete_comment_btn").click(function () {
      ...
      ajaxRequest('delete_comment_order','POST',{id:id},function (result) {
