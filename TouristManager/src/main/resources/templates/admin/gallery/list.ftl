...
<head>
    ...
    <title>${siteName!""}|Photo Library Management-${title!""}</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as photo>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${photo.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;width: 300px;">
                                                        <#if photo.images?? &&  photo.images?length gt 0>
                                                                <img src="/photo/view?filename=${ photo.images}"
                                                    ...
                                                    <td style="vertical-align:middle;">
                                                        <#if photo.status == 0>
                                                            <font class="text-success">show</font>
                                                        <#else>
                                                            <font class="text-warning">do not show</font>
                                                        </#if>
                                                    </td>

                                                    <td style="vertical-align:middle;">
                                                        <font class="text-success">${photo.createTime}</font>
                                                    </td>
                                                </tr>
                                            </#list>
                                        <#else>
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="list?title=${name!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
    ...
    function deleteReq(id, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('Photo library deleted successfully!', function () {
