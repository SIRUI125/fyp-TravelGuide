        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-danger">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">Total Number Of Users</p>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-success">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">Current Online Users</p>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-purple">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">Operation Log</p>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4>System recent operation log</h4>
              </div>
              <div class="card-body">
