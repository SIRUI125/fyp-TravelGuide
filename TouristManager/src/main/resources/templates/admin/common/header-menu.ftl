          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li> <a href="/system/update_pwd"><i class="mdi mdi-lock-outline"></i> Reset password</a> </li>
                <li class="divider"></li>
                <li> <a href="/system/logout"><i class="mdi mdi-logout-variant"></i> Sign Out</a> </li>
              </ul>
            </li>
            <!--切换主题配色-->
		    <li class="dropdown dropdown-skin">
			  ...
			  <ul class="dropdown-menu dropdown-menu-right" data-stopPropagation="true">
                <li class="drop-title"><p>Topic</p></li>
				...
				<li class="drop-title"><p>Sidebar</p></li>
				<li class="drop-skin-li clearfix">
                  <span class="inverse">
